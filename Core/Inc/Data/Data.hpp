...
static constexpr float BRAKING_DISTANCE = 48.0 - 24;
namespace Pinout{
...
namespace Communication_Data{
    static string Pcu_mac = "00:80:e1:15:00:00";
    static const IPV4 Backend = {"192.168.0.9"};
    static string PCU_IP = "192.168.1.5";
