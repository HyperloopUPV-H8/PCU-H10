...
class CurrentSensors{
    private: 
        ...
        LinearSensor<float> sensor_v_a{Pinout::CURRENT_SENSOR_V_A,Sensors_data::slope_current_sensor,Sensors_data::offset_current_sensor,&data->actual_current_sensor_v_a};
        LinearSensor<float> sensor_v_b{Pinout::CURRENT_SENSOR_V_B,Sensors_data::slope_current_sensor,Sensors_data::offset_current_sensor,&data->actual_current_sensor_v_b};
